...
apt_source_path="/etc/apt/sources.list.d/twindb_main.list"
apt_config_url="https://packagecloud.io/install/repositories/twindb/main/config_file.list?os=${os}&dist=${dist}&name=${host}&source=script"
